...
> **Note**
> The `terraform-iac-stack/` directory contains a ready-to-push copy of the same Terraform codebase so it can be imported into the external `terraform-iac-stack` repository without disturbing the legacy LocalStack assets that remain at the root of this project.
